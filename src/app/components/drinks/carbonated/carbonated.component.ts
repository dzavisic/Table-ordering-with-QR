...
@Component({
  selector: 'app-carbonated',
  templateUrl: './carbonated.component.html',
  styleUrls: ['./carbonated.component.scss'],
})
export class CarbonatedComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.drinks$ = this.drinkService.carb$.pipe(
      map(data => data.data)
    )
  }
