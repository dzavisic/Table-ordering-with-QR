...
@Component({
  selector: 'app-noncarbonated',
  templateUrl: './noncarbonated.component.html',
  styleUrls: ['./noncarbonated.component.scss'],
})
export class NoncarbonatedComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.drinks$ = this.drinkService.nonCarb$.pipe(
      map(data => data.data)
    )
  }
